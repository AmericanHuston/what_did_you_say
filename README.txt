...
5. Start the voice server by double clicking or typing "./startVoiceServer" in PowerShell or Command Prompt<sup>1</sup>
6. Enable the mod in the mods menu and have fun!

Note<sup>1</sup> : Linux and MacOS users should run the startVoiceServer.sh file either through
